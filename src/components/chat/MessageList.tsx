...
export default function MessageList({ messages, isLoading, hasError = false, onRetry, setInputValue }: MessageListProps) {
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] py-8 text-center">
        ...
        <div className="w-full max-w-xs space-y-3">
          ...
          <div className="grid grid-cols-1 gap-2">
            <button 
              onClick={() => setInputValue?.("How do I calculate my company's income tax if my turnover is ₦80 million?")}
            ...
            >
              <span className="flex-1">How do I calculate my company's income tax if my turnover is ₦80 million?</span>
          ...
          <div className="flex items-start max-w-[85%]">
            ...
            <div className="py-2 px-3 rounded-lg bg-white border border-gray-200 text-gray-800 rounded-bl-none shadow-md">
              <div className="flex space-x-1.5">
                ...
                <div className="h-2 w-2 bg-blue-500 rounded-full animate-[bounce_1.4s_infinite_ease-in-out_both]" style={{ animationDelay: "0.2s" }} />
                <div className="h-2 w-2 bg-blue-600 rounded-full animate-[bounce_1.4s_infinite_ease-in-out_both]" style={{ animationDelay: "0.4s" }} />
              </div>
            </div>
          </div>
        </div>
